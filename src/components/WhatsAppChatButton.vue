<!-- WhatsAppChatButton.vue (versión mejorada con localStorage) -->
<template>
    <div class="whatsapp-container">
        <!-- Botón de WhatsApp (visible siempre) -->
        <a :href="whatsappLink" class="whatsapp-button" target="_blank" rel="noopener noreferrer"
            aria-label="Contactar por WhatsApp" @mouseenter="handleMouseEnter" @mouseleave="handleMouseLeave">
...
import { setLocalStorage, getLocalStorage, isLocalStorageValid } from '@/utils/localStorage';
